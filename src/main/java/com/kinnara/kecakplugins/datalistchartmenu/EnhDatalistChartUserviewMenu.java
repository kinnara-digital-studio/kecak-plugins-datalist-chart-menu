...
public class EnhDatalistChartUserviewMenu extends UserviewMenu{
	...
	public String getRenderPage() {
		...
		String htmlContent = pluginManager.getPluginFreeMarkerTemplate(dataModel, getClassName(), "/templates/EnhDatalistChartUserviewMenu.ftl", "/messages/EnhDatalistChartUserviewMenu");
		return htmlContent;
	}
	...
	public String getPropertyOptions() {
		return AppUtil.readPluginResource(getClass().getName(), "/properties/EnhDatalistChartUserviewMenu.json", null, true, "/messages/EnhDatalistChartUserviewMenu");
	}

	@Override
	public String getName() {
		return "Enhanced Datalist Chart";
	}
